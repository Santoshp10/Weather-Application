const options = {
    method: 'GET',
    headers: {
        'X-RapidAPI-Key': 'f0cd133f02mshc16f71c766938a3p19cfb3jsn6a881eba405a',
...
const getWeather = (city) => {
    ...
    // Fourth Req 
    fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Rajastan', options)
        .then(response => response.json())
        .then((response) => {
            console.log(response)
    ...
    // Sixth Req 
    fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Landon', options)
        .then(response => response.json())
        .then((response) => {
            console.log(response)
